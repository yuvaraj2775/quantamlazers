...
import { Dialog } from '@headlessui/react'; // Adjust the import based on your setup

const Deleteconfirm = ({ deleteDialogOpen, cancelDelete, onDelete }) => {
  return (
    <Dialog
    ...
    >
      <Dialog.Backdrop onClick={cancelDelete} />

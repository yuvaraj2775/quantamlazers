...
const SuccessDialog = ({ open, onClose, dataId, onRedirect }) => (
      ...
      <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
        <DialogPanel className="relative transform overflow-hidden rounded-lg w-1/3 h-1/3 bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all">
          ...
          <div className="mt-5 sm:mt-6">
            <button type="button" onClick={() => { onClose(); onRedirect(); }} className="inline-flex w-full justify-center">

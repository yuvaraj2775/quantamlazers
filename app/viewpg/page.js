...
import MyModal from "../headless/MyModal";
...
export default function Page() {
  ...
  return (
    ...
    >
      ...
      <h1 className="text-right font-bold text-blue-600 mr-1">
      ...
      <div className="border-2 border-gray-300 mt-5 rounded-lg overflow-x-hidden shadow-sm">
        <table className="w-full">
          <thead className="bg-gray-200 font-semibold">
            <tr className="font-normal">
              <th className="p-2 border-2 border-r-gray-300">Sl. No</th>
              <th className="p-2 border-2 border-r-gray-300">
          ...
          <tbody>
            {formData.items.map((item, i) => (
              <tr key={i} className="border-b">
                <td className="p-2  border-2 w-10 border-r-gray-300 ">
                  {i + 1}
                </td>
                <td className="border-r-gray-300 border-2 px-2">
                  <input
                    ...
                    placeholder="Name"
                    className="w-64 h-10 border border-r-gray-300 capitalize rounded p-2 shadow-sm focus:outline-none focus:ring focus:ring-blue-300"
                  />
                </td>
                <td className="border-r-gray-300 border-2 px-2">
                  <input
                ...
                <td className="border-r-gray-300 border-2 px-2">
                  <textarea
                    ...
                    onChange={(e) => handleRowChange(i, e)}
                    placeholder="Remarks"
                    className="w-[230px] h-14 border capitalize rounded p-1 shadow-sm focus:outline-none focus:ring focus:ring-blue-300"
                  />
                </td>
                <td className="flex justify-center mt-3 items-center  border-gray-300 space-x-2 p-2">
                  <button
                    type="button"
